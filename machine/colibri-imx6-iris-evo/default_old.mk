...
LOCAL_CONF_OPT    = 'MACHINE            = "$(MACHINE)"'         \
                    ...
                    'TCLIBC             = "glibc"'              \
                    'CORE_IMAGE_EXTRA_INSTALL += " opkg dropbear screen tcl expect rsync socat dune canutils iproute2 ltrace file pciutils usbutils ethtool util-linux monit i2c-tools"' \
